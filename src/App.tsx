...
function App() {
  ...
  // Fetch all listings once on load.
  useEffect(() => {
    getListings()
      .then(setListings)
  ...
  // Derived state: filter in memory when a category is selected.
    ...
    <div style={{ maxWidth: 1000, margin: '0 auto', padding: '2rem 1rem' }}>
      <header style={{ marginBottom: '1.5rem' }}>
        <h1 style={{ margin: 0, fontSize: 32 }}>
          TripStack <span style={{ fontWeight: 400, color: '#6b7280' }}>· Ladakh trips</span>
        </h1>
        <p style={{ color: '#6b7280', marginTop: 4 }}>Book stays and rides for your Ladakh trip.</p>
      </header>
        ...
        >
          {visible.map((l) => (
            ...
            >
              ...
              <p style={{ fontSize: 14, color: '#4b5563', minHeight: 40, margin: '0 0 12px' }}>
                {l.description}
              </p>
